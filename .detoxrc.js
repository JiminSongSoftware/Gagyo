...
module.exports = {
  ...
  apps: {
    ...
    'ios.release': {
      type: 'ios.app',
      binaryPath: 'ios/build/Build/Products/Release-iphonesimulator/Gagyo.app',
      build: 'xcodebuild -workspace ios/Gagyo.xcworkspace -scheme Gagyo -configuration Release -sdk iphonesimulator -derivedDataPath ios/build',
    },
    'android.debug': {
      type: 'android.apk',
